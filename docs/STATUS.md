...
**Последнее обновление**: 2026-06-16 (этап 3 закрыт клиентом)
**Текущий этап**: между этапами — этап 4 (Блог) не начат
**Следующий шаг**: по команде клиента начать Этап 4 — раздел «Блог» (acceptance в ROADMAP)
...
**Этап**: нет активного (этап 3 закрыт, этап 4 ждёт команды клиента).
**Ветка**: `dev`
