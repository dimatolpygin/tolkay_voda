...
**Последнее обновление**: 2026-09-10 (этап 15 взят в работу — переезд на новый сервер)
**Текущий этап**: **15 — переезд на сервер `89.125.121.199`** (в работе). Майлстоуны 1–3 закрыты и в проде.
**Следующий шаг**: закрыть этап 15 тегом. Осталось два пункта вне моего контроля —
зелёный прогон GitHub Actions на первом пуше в `master` и подтверждение клиента.
...
| 15 | Переезд на новый сервер | 🚧 | `stage-15-done` | — | — |
...
**Этап 15 — переезд на `89.125.121.199`**: переезд выполнен 2026-09-10, DNS переключён
в 13:17 МСК. Сайт, эфир и бот работают на новом сервере; 9 из 11 критериев приёмки
закрыты. Осталось: зелёный прогон GitHub Actions на первом пуше в `master` и
подтверждение клиента. Детали и журнал — в [`07_ROADMAP.md`](07_ROADMAP.md).
...
холодный откат до ~2026-09-17, бот там остановлен. docker-compose
