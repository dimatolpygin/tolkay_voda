...
**Следующий шаг**: переключение DNS. Стек на новом сервере поднят и проверен по IP
(сайт 200, эфир звучит, база и кэш совпадают со старым). Нужен доступ к DNS Beget.
