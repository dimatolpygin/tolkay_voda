...
**Последнее обновление**: 2026-09-04 (спланирован майлстоун 4 — этапы 15–16)
**Текущий этап**: майлстоуны 1–3 закрыты и в проде. Спланирован **майлстоун 4**: переезд на новый сервер (этап 15) и рекламные баннеры под плеером (этап 16). Ни один не взят в работу.
**Следующий шаг**: этап 15 — переезд на `89.125.121.199` (сервер проверен, подходит; ждём подтверждения клиента, чей это сервер и почём). Этапы независимы — если переезд затормозит, можно начинать с этапа 16.
...
Активной работы нет — майлстоун 4 спланирован, но ни один этап не взят.
Критерии приёмки этапов 15 и 16 — в [`07_ROADMAP.md`](07_ROADMAP.md).
