...
Спланирован **этап 17** — веб-панель управления вместо бота (клиент не может
пользоваться Telegram). В работу не взят.
...
| 16 | Рекламные баннеры под плеером | ☐ | `stage-16-done` | — | — |
| 17 | Веб-панель управления вместо бота | ☐ | `stage-17-done` | — | — |
