...
**Последнее обновление**: 2026-09-11 (этап 16 закрыт — витрина баннеров в проде)
**Текущий этап**: этап 16 закрыт, витрина баннеров в проде. Майлстоуны 1–3 закрыты, этап 15 (переезд) закрыт.
**Следующий шаг**: этап 17 — веб-панель управления, после приёмки бот выводится из проекта.
...
Активной работы нет. Этап 16 закрыт 2026-09-11, витрина баннеров в проде
